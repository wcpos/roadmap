...
(async () => {
  ...
  await shot('flow-03-cart-back-toast');
  ...
  await act('[data-act="doMove"]'); await expect(/Paid out/, 'move failed'); await shot('flow-04b-paid-out-beat');
  ...
  await page.fill('[data-count="cash"]', '195'); await shot('flow-08b-exact'); await page.fill('[data-count="cash"]', '177.50');
  ...
  await act('[data-act="print"]'); await shot('flow-11-printed-stamp');
